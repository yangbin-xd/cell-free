...
if __name__ == "__main__":
    ...
    model = InterfModel()
    model_path = 'model/interf_full_map.pth'
    ...
    if os.path.exists(model_path):
        ...
        model, train_losses, val_losses = train_model(model, train_loader, val_loader,
                                                      num_epochs=500)
        # Save loss
        np.save('loss/interf_full_train_losses.npy', train_losses)
        np.save('loss/interf_full_val_losses.npy', val_losses)
    ...
    np.save('result/pred/pred_interf_full_mae.npy', mae_flatten)
