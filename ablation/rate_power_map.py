# rate prediction with the power-removed edge features (R1-3h)
import os
import torch
import numpy as np
import torch.nn as nn
from process import *
from signal_power_map import SignalModel
from interf_power_map import InterfModel
import rate_map as rm
from ablation_common import set_seed, add_common_args, variant_name, save_mae,\
    train_resumable, clear_ckpt, RATE_FORWARD, load_branch
